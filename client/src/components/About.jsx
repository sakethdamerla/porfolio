            ...
            <div className="container mx-auto max-w-4xl">
                ...
                >
                    ...
                    <div className="text-gray-300 space-y-4 md:space-y-6 text-xs md:text-lg leading-relaxed">
                        <p>
                            I am a passionate <span className="text-white font-semibold">Computer Science Student</span> and <span className="text-white font-semibold">Tech Creator</span> based in Kakinada.
